...
export class ExternalService {
  url: string =
    'https://apis.data.go.kr/1160100/service/GetStockSecuritiesInfoService/getStockPriceInfo?serviceKey=GS4AfFAtMpuTaa5EMX6Zgtbp1HiiFmFv3IwNocx9ajQ0k9pd8Atx47e4OxKjw%2FDPVL3LGsB0xwjSCSjxdLqJpg%3D%3D&numOfRows=10&pageNo=1&resultType=json';
  async getStockData() {
